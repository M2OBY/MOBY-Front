  ...
  < div className ="collapse navbar-collapse" id="navbarSupportedContent">
    <ul className="navbar-nav m-auto">
      ...
      <li className="nav-item">
        <Link className="nav-link text-white text-uppercase ml-5" to="dashboard">Dashboard</Link>
      </li>
      <li className="nav-item">
        <Link className="nav-link text-white text-uppercase ml-5" to="upload">Upload</Link>
      </li>
    </ul>
